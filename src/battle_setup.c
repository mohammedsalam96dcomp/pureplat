...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_BARRY_ROUTE_201_TURTWIG, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MAP_MT_CHIMNEY),
...
{
    CreateRandomMon(&gEnemyParty[0], SPECIES_BIDOOF, 2);
    LockPlayerFieldControls();
