...
#define OBJ_EVENT_GFX_PROF_ROWAN                  64
...
#define OBJ_EVENT_GFX_BARRY                      135
...
#define OBJ_EVENT_PAL_TAG_BARRY                   0x110D
